...
BASE_URL = 'https://nemasa.ch'
SCREENSHOTS_DIR = 'backend/uploads/brochure_steste'
...
def main():
    ...
    with sync_playwright() as p:
        ...
        try:
            page.goto(f"{BASE_URL}/auth/login", wait_until='networkidle', timeout=80000)
            time.sleep(2)
            ...
            if email_input and password_input:
                email_input.fill('admin@titelli.com')
